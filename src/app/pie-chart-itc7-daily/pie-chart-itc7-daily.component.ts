...
@Component({
  selector: 'app-pie-chart-itc7-daily',
  templateUrl: './pie-chart-itc7-daily.component.html',
  styleUrls: ['./pie-chart-itc7-daily.component.css']
})
export class PieChartITC7DailyComponent implements OnInit {
  ...
  ngOnInit() {
    this.DougnutmcserverService.getData(this.dougnutmcURL).subscribe(
      ...
      for(let i=0;i<this.data.length;i++){
        if(this.data[i].location_id==="ITC-7")
          {
