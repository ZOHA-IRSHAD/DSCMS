...
@Component({
  selector: 'app-pie-chart-itc6-daily',
  templateUrl: './pie-chart-itc6-daily.component.html',
  styleUrls: ['./pie-chart-itc6-daily.component.css']
})
export class PieChartITC6DailyComponent implements OnInit {
  ...
  ngOnInit() {
    this.DougnutmcserverService.getData(this.dougnutmcURL).subscribe(
      ...
      for(let i=0;i<this.data.length;i++){
        if(this.data[i].location_id==="ITC-6")
          {
